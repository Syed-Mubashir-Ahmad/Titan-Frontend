  ...
  const handleClose = () => setOpen(false);
    ...
    <ThemeProvider theme={theme}>
      ...
      <Grid container component="main" sx={{ height: '100vh' }}>
        ...
        <Grid item xs={12} sm={10}  component={Paper} square sx={{background: "#F5F6F8"}}>
        <TopBar moduleName="Roles"/>
        ...
        >
           <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <Typography fontSize={25} marginBottom={0} style={{fontWeight:600}}>
          Roles
        </Typography>
        ...
        {/* <Button onClick={handleOpen}
            ...
            <Table rows={rows} columns={columns} rowHeight={50} height={365}/>
    {/* <RolesTable/> */}
